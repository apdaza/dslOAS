...
public class InternalGuiOasLexer extends Lexer {
    ...
    public final void mRULE_URL() throws RecognitionException {
        try {
            int _type = RULE_URL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGuiOas.g:261:10: ( ( 'http' | 'https' ) '://' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '(' | ')' | '\\\\' | '/' | '.' | '0' .. '9' )+ )
            // InternalGuiOas.g:261:12: ( 'http' | 'https' ) '://' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '(' | ')' | '\\\\' | '/' | '.' | '0' .. '9' )+
            {
            // InternalGuiOas.g:261:12: ( 'http' | 'https' )
            int alt1=2;
            ...
            // InternalGuiOas.g:261:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '(' | ')' | '\\\\' | '/' | '.' | '0' .. '9' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGuiOas.g:263:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalGuiOas.g:263:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalGuiOas.g:263:11: ( '^' )?
            int alt3=2;
            ...
            // InternalGuiOas.g:263:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGuiOas.g:265:10: ( ( '0' .. '9' )+ )
            // InternalGuiOas.g:265:12: ( '0' .. '9' )+
            {
            // InternalGuiOas.g:265:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGuiOas.g:267:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalGuiOas.g:267:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalGuiOas.g:267:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalGuiOas.g:267:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalGuiOas.g:267:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalGuiOas.g:267:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalGuiOas.g:267:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGuiOas.g:269:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalGuiOas.g:269:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalGuiOas.g:269:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGuiOas.g:271:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalGuiOas.g:271:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalGuiOas.g:271:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGuiOas.g:273:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalGuiOas.g:273:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalGuiOas.g:273:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGuiOas.g:275:16: ( . )
            // InternalGuiOas.g:275:18: .
            {
            matchAny(); 
